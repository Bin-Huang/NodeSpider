...
ava_1.default.serial("test for method 'addU': basic", async (t) => {
...
ava_1.default.serial("test for method 'addU': filter", async (t) => {
    const url1 = "http://test1.com";
...
ava_1.default.serial("test for method 'addU' with info", async (t) => {
...
ava_1.default.serial("test for method 'addU' with urls", async (t) => {
...
ava_1.default.serial("test for method 'addU' with urls and info", async (t) => {
...
//# sourceMappingURL=addU.test.js.map