...
export type TStreamPlanOptionCallback = (req: stream.Readable, current: IStreamPlanOptionCallbackCurrent, end) => void;
...
// 传入plan的option的callback执行的current
...
function process(task: IStreamPlanTask, self: NodeSpider) {
    return new Promise((resolve, reject) => {
        ...
        const current: IStreamPlanOptionCallbackCurrent = {
            ...task,
